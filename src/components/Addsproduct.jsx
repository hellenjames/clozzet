function Addsproduct(){
    return(
        ...
        <h1 className="text-center font-sans text-2xl">Add New Product</h1>
        ...
        <div className="flex items-center">
        <button className="border border-gray-400 bg-[#45C9A1] rounded-full text-white px-[4em] py-3 font-bold ">add products</button>
        </div>
    </div>
    </div>
    )
}
export default Addsproduct